  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navigasi">
        <div class="container cnav">
            <img src="img/logo.png" alt="Bootstrap" width="76" height="76">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav" >
              ...
              <li class="nav-item mx-0.1">
                <a class="btn btn-primary tombol px-4" style="margin-left: 50px" href="/mainAdmin">Login</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <section id="hero" class="hero">
          <div class="row" style="height: 732px; margin-top:10px">
              ...
              <div class="col img-fluid">
                <img src="img/kiri.png" alt="" style="margin-left: 51.6px">
